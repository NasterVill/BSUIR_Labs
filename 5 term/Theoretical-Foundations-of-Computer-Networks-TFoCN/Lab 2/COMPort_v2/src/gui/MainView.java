...
public class MainView {
    ...
    public MainView(SerialPortController serialPortController) {
        ...
        OutputView outputView = new OutputView(serialPortController,
                outputArea,
                MIN_WIDTH,
                MIN_HEIGHT
        );
        ...
        final double height = MIN_HEIGHT * 4 + 140;
    ...
    public TextArea getPackageArea() {
        return packageArea;
    }

    public ComboBox<String> getDestinationList() {
